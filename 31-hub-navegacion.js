...
function verificarEstadoHub() {
    ...
    // Roce #9: si hay un banner de error temporal mostrándose
    // (ej. "JORNADA REQUERIDA" que pintó navegarA), no lo pisamos.
    // Se auto-limpiará tras 6s desde mostrarBannerJornadaRequerida().
    if (window._mostrandoErrorJornada) return;
